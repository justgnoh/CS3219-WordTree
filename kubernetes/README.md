...
For DEBUGGING backend services, you can just connect directly to localhost:<nodePortNum for your service> (refer to 3-service.yaml) like how you did for docker-compose
